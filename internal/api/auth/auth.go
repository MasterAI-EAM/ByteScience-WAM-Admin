...
// @Router /login [post]
func (*Api) Login(ctx *gin.Context, req *auth.LoginRequest) (res *auth.LoginResponse, err error) {
...
func (*Api) ChangPassword(ctx *gin.Context, req *auth.ChangePasswordRequest) (res *dto.Empty, err error) {

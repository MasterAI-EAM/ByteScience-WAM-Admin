...
// RegisterRoute 封装了请求参数绑定和统一响应，支持具体返回类型
func RegisterRoute[T any, R any](group *gin.RouterGroup, method, path string, handlerFunc func(ctx *gin.Context, req *T) (R, error)) {
